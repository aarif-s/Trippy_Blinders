...
const trips = [
      ...
      description: [
        {
          ...
          activities: [
            ...
            "Assistance with transfer to hotel",
            "Hotel check-in and relax",
            "Dinner at the hotel with traditional Turkish and international cuisine",
    ...
    },
    {
      id: 2,
      day: "Day 2",
      title: "Exploring the Historic Heart of Istanbul",
      dayName: "Day 2",
      description: [
        {
          time: "Morning",
          activities: [
            ...
            "Guided tour to Hagia Sophia, Blue Mosque, and Topkapi Palace",
        ...
        },
        {
          time: "Afternoon",
          activities: [
            "Lunch at a local restaurant with traditional Turkish dishes",
            "Return to the hotel for relaxation",
            "Dinner at the hotel featuring fresh seasonal ingredients",
          ],
        },
        {
          time: "Evening",
    ...
    },
    {
      id: 3,
      day: "Day 3",
      title: "Bosphorus Cruise & Asian Side Tour",
      dayName: "Day 3",
      description: [
        {
          time: "Morning",
          activities: [
            "Breakfast at the hotel",
            "Bosphorus Cruise with scenic views of Istanbul",
        ...
        },
        {
          time: "Afternoon",
          activities: [
            "Lunch at a local restaurant with Anatolian regional dishes",
            "Tour of Istanbul's Asian side, exploring its picturesque streets",
          ],
        },
        {
          time: "Evening",
  ...
  const inclusions = [
    {
      ...
      description: "Accommodation in 3-star or 4-star hotel with breakfast and dinner daily",
    },
    {
      id: 2,
      category: "Transport",
      description: "Air-conditioned vehicles with English-speaking drivers for transfers and tours",
    },
    {
      id: 3,
      category: "Meals",
      description: "Breakfast and dinner at the hotel; lunch during tours at local restaurants",
    },
    {
      id: 4,
      category: "Guided Tours",
      description: "Professional English-speaking guide for all scheduled tours",
    },
    {
      id: 5,
      category: "Bosphorus Cruise",
      description: "Round-trip Bosphorus cruise with scenic views of Istanbul",
    },
    {
      id: 6,
      category: "Airport Transfers",
      description: "Pick-up and drop-off services from/to Istanbul Airport",
    },
  ];
  
  const exclusions = [
    { id: 1, description: "International Flights (to/from Istanbul)" },
    { id: 2, description: "Personal expenses (shopping, meals outside itinerary)" },
    { id: 3, description: "Travel insurance (optional)" },
    { id: 4, description: "Optional activities not mentioned in the itinerary" },
    { id: 5, description: "Tips & gratuities (at guest’s discretion)" },
  ];
  ...
  return (
    <div className="min-h-screen pt-16 bg-gray-50">
      ...
      <div
        ...
        style={{
          backgroundImage:
            'url("https://images.unsplash.com/photo-1623621534850-d325a1980c7e?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")',
        }}
      >
        <div className="w-full h-full bg-black bg-opacity-60 rounded-lg flex flex-col lg:flex-row items-center justify-between px-6 lg:px-20 py-12 lg:py-0 text-center lg:text-left pt-16">
          <div className="text-white max-w-lg mb-6 lg:mb-0">
            <h1 className="text-3xl lg:text-5xl font-bold mb-4 leading-tight">
              ...
              <span className="text-yellow-400">Turkey Istanbul Trip</span>
            </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
        <section className="py-10 bg-gray-100">
          <h2 className="text-4xl font-bold text-center mb-12 text-gray-800">
            Explore <span className="text-blue-500">Turkey Istanbul Tour</span>
          </h2>
          ...
          <div className="flex flex-col space-y-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              Turkey Istanbul Itinerary 3 Nights 4 Days
              </h3>
...
export default Turkey_istanbul_tour;
