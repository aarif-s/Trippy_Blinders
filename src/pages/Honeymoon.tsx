...
import HoneymoonTrips from '../components/HoneymoonTrips';
import ContactForm from '../components/ContactForm';
import HoneymoonTripsRecommend from '../components/HoneymoonTripsRecommend';
  ...
  return (
    <div className="min-h-screen pt-16 bg-gray-50">
      ...
      <div
        ...
        style={{
          backgroundImage:
            'url("https://www.gtholidays.in/wp-content/uploads/2022/02/India-Honeymoon-Packages.jpg")',
        }}
      >
        ...
        <div className="w-full h-full bg-black bg-opacity-60 rounded-lg flex flex-col lg:flex-row items-center justify-between px-6 lg:px-20 py-12 lg:py-0 text-center lg:text-left pt-16">
          ...
          <div className="text-white max-w-lg mb-6 lg:mb-0">
            <h1 className="text-3xl lg:text-5xl font-bold mb-4 leading-tight">
              Explore the Beauty of <span className="text-yellow-400">Honeymoon Trips</span>
            </h1>
            <p className="text-lg text-gray-300">
              Discover incredible Honeymoon travel destinations and make lasting memories. Book your next adventure with us!
            </p>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
        <h1 className="text-4xl font-bold text-center mb-12 text-gray-800">
          Explore <span className="text-blue-500">Upcoming Honeymoon Trips</span>
        </h1>
