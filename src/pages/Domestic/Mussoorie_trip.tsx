  ...
  const trips = [
      ...
      description: [
        {
          time: "",
          activities: [
            "Pickup from Dehradun Airport/Railway Station",
            "Scenic drive to Mussoorie (approx. 2 hours)",
            "Check-in at hotel",
            "Evening at leisure – explore Mall Road, enjoy local snacks",
            "Dinner at the hotel",
      ...
      description: [
        {
          ...
          activities: [
            "Breakfast at hotel",
            "Visit Kempty Falls – popular picnic spot",
            "Explore Company Garden – beautifully maintained garden with boating facility",
            "Gun Hill Point – panoramic views of the Himalayas",
            "Camel’s Back Road – ideal for a peaceful walk",
            "Visit Mussoorie Christ Church (optional)",
    ...
    },
    {
      id: 3,
      day: "Day 3",
      title: "Excursion to Dhanaulti & Eco Park",
      dayName: "Day 3",
      description: [
        {
          time: "",
          activities: [
            "Breakfast at hotel",
            "Day excursion to Dhanaulti (approx. 25 km)",
            "Visit Eco Park – ideal for nature walks and forest trails",
            "Optional visit to Surkanda Devi Temple (moderate trek)",
    ...
    },
    {
      id: 4,
      day: "Day 4",
      title: "Departure from Mussoorie to Dehradun",
      dayName: "Day 4",
      description: [
        {
          time: "",
          activities: [
            "Breakfast at hotel",
            "Check-out and drive back to Dehradun",
            "Drop at Dehradun Airport/Railway Station for onward journey"
          ]
        }
      ]
    }
  ...
  const inclusions = [
    { id: 1, category: "Stay", description: "Accommodation for 3 Nights in a standard hotel" },
    { id: 2, category: "Meals", description: "Daily Breakfast & Dinner" },
    { id: 3, category: "Transport", description: "All transfers and sightseeing by private cab (AC will not operate in hill areas)" },
    { id: 4, category: "Taxes", description: "Toll taxes, parking charges, driver allowance" },
    { id: 5, category: "Pickup/Drop", description: "Pickup & drop from Dehradun Airport/Railway Station" },
    { id: 6, category: "Hotel Tax", description: "All applicable hotel taxes" }
  ];
  
  const exclusions = [
    { id: 1, description: "Airfare / Train fare" },
    { id: 2, description: "Lunch, snacks, and beverages not mentioned" },
    { id: 3, description: "Personal expenses like laundry, tips, telephone calls, room service" },
    { id: 4, description: "Entry tickets to monuments, activities, or adventure sports" },
    { id: 5, description: "Travel Insurance" },
    { id: 6, description: "Anything not mentioned under “Inclusions”" }
  ];
    ...
    return (
      <div className="min-h-screen pt-16 bg-gray-50">
        ...
        <div
          ...
          style={{
            backgroundImage:
             'url("https://plus.unsplash.com/premium_photo-1661954549947-0d13708b87bd?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")',
          }}
        >
          <div className="w-full h-full bg-black bg-opacity-60 rounded-lg flex flex-col lg:flex-row items-center justify-between px-6 lg:px-20 py-12 lg:py-0 text-center lg:text-left pt-16">
            <div className="text-white max-w-lg mb-6 lg:mb-0">
              <h1 className="text-3xl lg:text-5xl font-bold mb-4 leading-tight">
                ...
                <span className="text-yellow-400">Mussoorie Trip</span>
              </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
          <section className="py-10 bg-gray-100">
            <h2 className="text-4xl font-bold text-center mb-12 text-gray-800">
              Explore <span className="text-blue-500">Upcoming Massoorie Trip</span>
            </h2>
            ...
            <div className="flex flex-col space-y-8">
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                Mussoorie Itinerary : 4 days / 3 Nights
                </h3>
