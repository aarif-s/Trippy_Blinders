...
const trips = [
  {
    ...
    description: [
      ...
      },
      {
        time: "Afternoon",
        activities: [
          "Visit the Hadimba Devi Temple, a serene 15th-century temple set amidst cedar forests",
          "Explore the nearby Manu Temple dedicated to Sage Manu",
        ],
      },
      {
        time: "Evening",
        activities: [
          "Stroll through Old Manali's quaint streets, known for their cafes and local shops",
          "Enjoy dinner at a local café with views of the surrounding mountains",
        ],
      },
    ],
  },
    ...
    description: [
      {
        time: "Morning",
        activities: [
          "Head to Solang Valley for adventure activities like paragliding, zorbing, or skiing (seasonal)",
          "Capture panoramic views of the snow-capped mountains",
        ],
      },
      {
        time: "Afternoon",
        activities: [
          "Enjoy lunch at a local eatery in Solang Valley",
          "Visit the nearby Anjani Mahadev Temple, known for its natural Shivling formed by waterfalls",
        ],
      },
      {
        time: "Evening",
        activities: [
          ...
          "Dinner at a local restaurant featuring Himachali cuisine",
        ],
      },
    ],
  },
  {
    id: 3,
    day: "Day 3",
    title: "Excursion to Rohtang Pass",
    dayName: "Wednesday",
    description: [
      {
        time: "Morning",
        activities: [
          "Early morning departure to Rohtang Pass (subject to weather conditions and permits)",
          "Experience snow activities and enjoy the breathtaking landscape",
        ],
      },
      {
        time: "Afternoon",
        activities: [
          "Lunch at a roadside dhaba en route back to Manali",
          "Visit the Rahala Waterfalls on the way back",
        ],
      },
      {
        time: "Evening",
        activities: [
          "Explore Mall Road for shopping and local handicrafts",
    ...
    description: [
      {
        time: "Morning",
        activities: [
          "Visit Vashisht Village to experience the natural hot springs",
          "Explore the Vashisht Temple and surrounding area",
        ],
      },
      {
        time: "Afternoon",
        activities: [
          "Lunch at a café overlooking the Beas River",
          "Pack up and check out from the hotel",
        ],
      },
      {
        time: "Evening",
  ...
  return (
    <div className="min-h-screen pt-16 bg-gray-50">
      ...
      <div
        ...
        style={{
          backgroundImage:
           'url("https://images.unsplash.com/photo-1602216056096-3b40cc0c9944?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")',
        }}
      >
        <div className="w-full h-full bg-black bg-opacity-60 rounded-lg flex flex-col lg:flex-row items-center justify-between px-6 lg:px-20 py-12 lg:py-0 text-center lg:text-left pt-16">
          <div className="text-white max-w-lg mb-6 lg:mb-0">
            <h1 className="text-3xl lg:text-5xl font-bold mb-4 leading-tight">
              ...
              <span className="text-yellow-400">Kerala Trip</span>
            </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
        <section className="py-10 bg-gray-100">
          <h2 className="text-4xl font-bold text-center mb-12 text-gray-800">
            Explore <span className="text-blue-500">Upcoming Kerala Trips</span>
          </h2>
