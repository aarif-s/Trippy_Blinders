...
const trips = [
  {
    ...
    description: [
      ...
      },
      {
        time: "Evening",
        activities: [
          "Visit the Cellular Jail and enjoy the Light and Sound Show",
          "Dinner at the hotel",
    ...
    description: [
      {
        ...
        activities: [
          ...
          "Transfer to Port Blair Harbour",
  ...
  },
  {
    id: 3,
    day: "Day 3",
    title: "Havelock Island - Water Sports",
    dayName: "Wednesday",
    description: [
      {
        time: "Morning",
        activities: [
          ...
          "Snorkeling, scuba diving or glass-bottom boat ride at Elephant Beach",
        ],
      },
      {
        time: "Evening",
  ...
  },
  {
    ...
    description: [
      ...
      },
      {
        time: "Afternoon",
        activities: [
          "Leisure time for shopping or relaxation",
        ],
      },
      {
        time: "Evening",
...
const inclusions = [
  {
    id: 1,
    category: "Stay",
    description: "Accommodation in 3-star/4-star hotels or resorts as per the itinerary.",
  },
  {
    id: 2,
    category: "Meal",
  ...
  },
  {
    id: 3,
    category: "Transport",
    description: "All transfers by private AC cab and ferry tickets as per itinerary.",
  },
  {
    id: 4,
    category: "Sightseeing",
    description: "All entry fees and sightseeing activities as per itinerary.",
  },
  {
    id: 5,
    category: "Other Inclusions",
    description: "24/7 assistance and guided tours where applicable.",
  },
];
...
const exclusions = [
  {
    id: 1,
    description: "Lunch (unless specifically mentioned).",
  },
  {
    id: 2,
  ...
  {
    id: 3,
    description: "Optional water sports or activities not included in the itinerary.",
  },
  {
    id: 4,
    description: "Travel insurance, if required.",
  },
  {
    id: 5,
    description: "Any applicable GST or government taxes.",
  },
];
  ...
  return (
    <div className="min-h-screen pt-16 bg-gray-50">
      ...
      <div
        ...
        style={{
          backgroundImage:
            'url("https://images.unsplash.com/photo-1723203606060-b0390c387a81?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")',
        }}
      >
        <div className="w-full h-full bg-black bg-opacity-60 rounded-lg flex flex-col lg:flex-row items-center justify-between px-6 lg:px-20 py-12 lg:py-0 text-center lg:text-left pt-16">
          <div className="text-white max-w-lg mb-6 lg:mb-0">
            <h1 className="text-3xl lg:text-5xl font-bold mb-4 leading-tight">
              ...
              <span className="text-yellow-400">Andaman Island Trip</span>
            </h1>
...
export default Andaman_island_trip;
