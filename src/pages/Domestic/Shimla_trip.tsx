...
const trips = [
    ...
    description: [
      {
        ...
        activities: [
          ...
          "Optional: Adventure activities at Kufri Fun World",
  ...
  },
  {
    id: 3,
    day: "Day 3",
    title: "Excursion to Naldehra and Tattapani",
    dayName: "Day 3",
    description: [
      {
        time: "",
        activities: [
          "Breakfast at hotel",
          "Full-day excursion to Naldehra (famous for its golf course and natural beauty)",
          "Visit Tattapani – optional river rafting and natural hot water springs",
          "Return to hotel in the evening",
          "Dinner at hotel",
          "Overnight stay in Shimla"
        ]
...
const exclusions = [
  ...
  { id: 2, description: "Lunch and personal expenses such as laundry, tips, telephone calls, etc." },
  { id: 3, description: "Entry tickets to monuments, parks, or activities" },
  { id: 4, description: "Any extra charges incurred during natural calamities or political unrest" },
  { id: 5, description: "Travel insurance" },
  { id: 6, description: "Anything not mentioned in the inclusions" }
];
        ...
        <div className="w-full h-full bg-black bg-opacity-60 rounded-lg flex flex-col lg:flex-row items-center justify-between px-6 lg:px-20 py-12 lg:py-0 text-center lg:text-left pt-16">
          <div className="text-white max-w-lg mb-6 lg:mb-0">
            <h1 className="text-3xl lg:text-5xl font-bold mb-4 leading-tight">
              ...
              <span className="text-yellow-400">Shimla Trip</span>
            </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
        <section className="py-10 bg-gray-100">
          <h2 className="text-4xl font-bold text-center mb-12 text-gray-800">
            Explore <span className="text-blue-500">Upcoming Shimla Trips</span>
          </h2>
