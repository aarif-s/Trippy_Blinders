...
const trips = [
        {
          id: 1,
          day: "Day 1",
          title: "Arrival in Bodhgaya",
          dayName: "Day 1",
          description: [
            {
              time: "",
              activities: [
                "Arrival at Gaya Airport / Railway Station",
                "Meet and greet by our representative",
                "Transfer to the hotel and check-in",
                "Visit Mahabodhi Temple, Bodhi Tree, Animesh Lochan Chaitya, and Great Buddha Statue",
                "Return to the hotel",
                "Dinner at the hotel",
        ...
        },
        {
          id: 2,
          day: "Day 2",
          title: "Local Sightseeing in Bodhgaya",
          dayName: "Day 2",
          description: [
            {
              time: "",
              activities: [
                ...
                "Visit Thai Monastery, Japanese Temple and Buddhist Monastery, Royal Bhutan Monastery, Indosan Nippon Japanese Temple",
                "Explore Sujata Kuti and Sujata Garh (site related to Sujata who offered milk-rice to Buddha)",
                "Optional: Attend evening meditation session",
                "Return to the hotel",
                "Dinner at the hotel",
                "Overnight stay in Bodhgaya"
              ]
          ...
          description: [
            {
              ...
              activities: [
                ...
                "Transfer to Gaya Airport / Railway Station for onward journey"
              ]
            }
          ]
        }
      ...
      const inclusions = [
        { id: 1, category: "Stay", description: "Accommodation in well-rated hotel on double occupancy basis" },
        { id: 2, category: "Meal", description: "Daily Breakfast and Dinner at the hotel" },
        { id: 3, category: "Transport", description: "All transfers and sightseeing by private AC cab" },
        { id: 4, category: "Service", description: "Driver charges, tolls, parking, and fuel cost" },
        { id: 5, category: "Support", description: "24/7 tour assistance and customer support" },
        { id: 6, category: "Tax", description: "All applicable hotel taxes" }
      ];
      
      const exclusions = [
        { id: 1, description: "Airfare / Train fare to and from Gaya" },
        { id: 2, description: "Any personal expenses such as laundry, tips, or telephone calls" },
        { id: 3, description: "Entry fees to monuments and activities not mentioned in inclusions" },
        { id: 4, description: "Travel insurance" },
        { id: 5, description: "Any item not specifically mentioned in the inclusions" },
        { id: 6, description: "Extra meals or beverages not included in the itinerary" }
      ];
  ...
  return (
    <div className="min-h-screen pt-16 bg-gray-50">
      ...
      <div
        ...
        style={{
          backgroundImage:
            'url("https://images.unsplash.com/photo-1667883643074-31b942669d08?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")',
        }}
      >
        <div className="w-full h-full bg-black bg-opacity-60 rounded-lg flex flex-col lg:flex-row items-center justify-between px-6 lg:px-20 py-12 lg:py-0 text-center lg:text-left pt-16">
          <div className="text-white max-w-lg mb-6 lg:mb-0">
            <h1 className="text-3xl lg:text-5xl font-bold mb-4 leading-tight">
              ...
              <span className="text-yellow-400">Bodhgaya Tour</span>
            </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
        <section className="py-10 bg-gray-100">
          <h2 className="text-4xl font-bold text-center mb-12 text-gray-800">
            Explore <span className="text-blue-500">Bodhgaya</span>
          </h2>
          ...
          <div className="flex flex-col space-y-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              Bodhgaya Tour Itinerary 3 Days / 2 Nights
              </h3>
