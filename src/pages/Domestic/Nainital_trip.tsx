  ...
  const trips = [
      ...
      description: [
        {
          time: "",
          activities: [
            "Pickup from Kathgodam Railway Station / Pantnagar Airport by private cab",
            "Transfer to the pre-booked hotel in Nainital",
            "Check-in and relax after the journey",
            "Evening leisure walk around Mall Road or visit the local Tibetan Market",
            "Dinner at the hotel",
      ...
      description: [
        {
          ...
          activities: [
            "Breakfast at hotel",
            "Sightseeing: Naini Lake (boating at your own cost), Naina Devi Temple",
            "Visit Snow View Point, Tiffin Top, Eco Cave Garden, and Lover’s Point",
            "Explore Mall Road for shopping and snacks",
    ...
    },
    {
      id: 3,
      day: "Day 3",
      title: "Excursion to Bhimtal, Sattal & Naukuchiatal",
      dayName: "Day 3",
      description: [
        {
          time: "",
          activities: [
            "Breakfast at hotel",
            "Full-day excursion to Bhimtal, Sattal, and Naukuchiatal",
            "Visit Hanuman Garhi Temple",
            "Enjoy boating and nature walks in serene surroundings",
      ...
      description: [
        {
          ...
          activities: [
            ...
            "Transfer to Kathgodam Railway Station / Pantnagar Airport by cab",
            "Tour ends with beautiful memories of Nainital"
          ]
        }
      ]
    }
  ...
  const inclusions = [
    { id: 1, category: "Stay", description: "Accommodation in well-appointed hotel rooms on twin/triple sharing basis" },
    { id: 2, category: "Meals", description: "Daily Breakfast & Dinner at the hotel" },
    { id: 3, category: "Transport", description: "Private cab for all transfers and sightseeing as per the itinerary" },
    { id: 4, category: "Pickup/Drop", description: "Pickup & drop from Kathgodam Railway Station / Pantnagar Airport" },
    { id: 5, category: "Hotel Tax", description: "All applicable hotel taxes" }
  ];
  
  const exclusions = [
    { id: 1, description: "Airfare / Train fare" },
    { id: 2, description: "Lunch, snacks, and beverages" },
    { id: 3, description: "Personal expenses such as laundry, telephone calls, and room service" },
    { id: 4, description: "Entry fees to monuments, boating, ropeway charges, and any adventure activities" },
    { id: 5, description: "Any additional sightseeing or services not mentioned in the itinerary" },
    { id: 6, description: "Travel insurance" },
    { id: 7, description: "GST and any kind of tips" }
  ];
          ...
          <div className="w-full h-full bg-black bg-opacity-60 rounded-lg flex flex-col lg:flex-row items-center justify-between px-6 lg:px-20 py-12 lg:py-0 text-center lg:text-left pt-16">
            <div className="text-white max-w-lg mb-6 lg:mb-0">
              <h1 className="text-3xl lg:text-5xl font-bold mb-4 leading-tight">
                ...
                <span className="text-yellow-400">Nainital Trip</span>
              </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
          <section className="py-10 bg-gray-100">
            <h2 className="text-4xl font-bold text-center mb-12 text-gray-800">
              Explore <span className="text-blue-500">Upcoming Nainital Trip</span>
            </h2>
            ...
            <div className="flex flex-col space-y-8">
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                Nainital Itinerary : 4 days / 3 Nights
                </h3>
