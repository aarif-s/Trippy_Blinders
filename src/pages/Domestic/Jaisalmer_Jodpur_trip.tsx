...
const trips = [
    {
      ...
      description: [
        ...
        },
        {
          time: "Afternoon",
          activities: [
            "Explore Jaisalmer Fort (Sonar Quila), one of the largest fortresses in the world",
          ],
        },
        {
          time: "Evening",
          activities: [
            ...
            "Enjoy sunset views from a scenic spot",
            "Overnight stay in a hotel in Jaisalmer",
          ],
        },
      ],
    },
    {
      id: 2,
      day: "Day 2",
      title: "Desert Safari and Jaisalmer Sightseeing",
      dayName: "Tuesday",
      description: [
        {
          time: "Morning",
          activities: [
            "Visit Jaisalmer War Museum or Bada Bagh (royal cenotaphs)",
          ],
        },
        {
          time: "Afternoon",
          activities: [
            "Head to Sam Sand Dunes (~50 km from Jaisalmer)",
            "Begin desert safari: camel ride, jeep safari",
          ],
        },
        {
          time: "Evening",
          activities: [
            ...
            "Enjoy traditional Rajasthani folk dance and music",
      ...
      description: [
        {
          time: "Morning",
          activities: [
            "Depart for Jodhpur (approx. 4–5 hours)",
          ],
        },
        {
          time: "Afternoon",
          activities: [
            "Check into hotel in Jodhpur",
            "Visit Mehrangarh Fort and museum",
            "Enjoy panoramic views of the Blue City",
          ],
        },
        {
          time: "Evening",
          activities: [
            "Explore Clock Tower and Sardar Market",
            "Try local street food like methi ladoo and mirchi vada",
    ...
    },
    {
      id: 4,
      day: "Day 4",
      title: "Jodhpur Sightseeing and Departure",
      dayName: "Thursday",
      description: [
        {
          time: "Morning",
          activities: [
            "Visit Umaid Bhawan Palace (museum and royal residence)",
            "Optional: Explore Mandore Gardens with temples and cenotaphs",
          ],
        },
        {
          time: "Afternoon",
          activities: [
            "If time permits, visit Jaswant Thada",
  ...
  return (
    <div className="min-h-screen pt-16 bg-gray-50">
      ...
      <div
        ...
        style={{
          backgroundImage:
            'url("https://images.unsplash.com/photo-1709620220232-12ecd7ca33a8?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")',
        ...
        <div className="w-full h-full bg-black bg-opacity-60 rounded-lg flex flex-col lg:flex-row items-center justify-between px-6 lg:px-20 py-12 lg:py-0 text-center lg:text-left pt-16">
          <div className="text-white max-w-lg mb-6 lg:mb-0">
            <h1 className="text-3xl lg:text-5xl font-bold mb-4 leading-tight">
              ...
              <span className="text-yellow-400">Jaisalmer Jodpur Trip</span>
            </h1>
...
export default Jaisalmer_Jodpur_trip;
