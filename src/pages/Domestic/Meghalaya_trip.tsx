  ...
  const trips = [
      ...
      description: [
        {
          ...
          activities: [
            ...
            "Drive to Shillong (approx. 3-4 hrs)",
            "En route visit Umiam Lake – a tranquil reservoir surrounded by hills",
            "Check-in at hotel",
            "Leisure evening at Police Bazaar",
      ...
      description: [
        {
          time: "",
          activities: [
            "After breakfast, full-day sightseeing in and around Shillong",
            "Places to visit: Shillong Peak, Elephant Falls, Don Bosco Museum, Ward's Lake, Cathedral of Mary Help of Christians",
            "Evening at leisure",
            "Overnight stay in Shillong",
      ...
      description: [
        {
          time: "",
          activities: [
            "After breakfast, check out and drive to Cherrapunjee (approx. 2 hrs)",
            "En route stop at Mawkdok Dympep Valley Viewpoint",
            "Explore attractions in Cherrapunjee: Nohkalikai Falls, Seven Sisters Falls, Mawsmai Cave, Eco Park",
      ...
      description: [
        {
          ...
          activities: [
            "Early breakfast",
            "Full-day guided trek to the famous Double Decker Living Root Bridge in Nongriat",
            "Experience the unique bio-engineering and natural beauty of the trek",
            "Return by evening",
            "Overnight stay in Cherrapunjee",
            "Meals: Breakfast & Dinner"
          ]
      ...
      description: [
        {
          time: "",
          activities: [
            "After breakfast, proceed to Dawki (approx. 2 hrs)",
            "Visit Umngot River for crystal clear boat rides",
            "Continue to Mawlynnong – Asia's cleanest village",
            "Visit the Balancing Rock and Living Root Bridge (single root)",
    ...
    },
    {
      id: 6,
      day: "Day 6",
      title: "Shillong – Departure from Guwahati",
      dayName: "Day 6",
      description: [
        {
          time: "",
          activities: [
            ...
            "Drive back to Guwahati (3-4 hrs)",
  ...
  const inclusions = [
    { id: 1, category: "Stay", description: "Accommodation on twin/double sharing basis in well-rated hotels" },
    { id: 2, category: "Meals", description: "Daily breakfast and dinner at hotel" },
    { id: 3, category: "Transport", description: "Private cab for all transfers and sightseeing as per itinerary" },
    { id: 4, category: "Tolls & Allowances", description: "All tolls, parking, fuel charges, and driver allowance" },
    { id: 5, category: "Sightseeing", description: "Sightseeing as per itinerary" },
    { id: 6, category: "Guide", description: "Local guide for Double Decker Root Bridge trek" },
    { id: 7, category: "Activity", description: "Boating in Dawki (standard boat)" }
  ];
  
  const exclusions = [
    { id: 1, description: "Airfare/Train fare to and from Guwahati" },
    { id: 2, description: "Lunches, snacks, and beverages" },
    { id: 3, description: "Personal expenses like laundry, tips, and shopping" },
    { id: 4, description: "Entry fees at monuments/parks/museums not mentioned above" },
    { id: 5, description: "Travel insurance" },
    { id: 6, description: "Any other services not mentioned in the inclusions" }
  ];
    ...
    return (
      <div className="min-h-screen pt-16 bg-gray-50">
        ...
        <div
          ...
          style={{
            backgroundImage:
             'url("https://images.unsplash.com/photo-1593813738953-fb3c93e0769d?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")',
          }}
        >
          <div className="w-full h-full bg-black bg-opacity-60 rounded-lg flex flex-col lg:flex-row items-center justify-between px-6 lg:px-20 py-12 lg:py-0 text-center lg:text-left pt-16">
            <div className="text-white max-w-lg mb-6 lg:mb-0">
              <h1 className="text-3xl lg:text-5xl font-bold mb-4 leading-tight">
                ...
                <span className="text-yellow-400">Meghalaya Trip</span>
              </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
          <section className="py-10 bg-gray-100">
            <h2 className="text-4xl font-bold text-center mb-12 text-gray-800">
              Explore <span className="text-blue-500">Meghalaya Trips</span>
            </h2>
            ...
            <div className="flex flex-col space-y-8">
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                Meghalaya Trip Itinerary : 6 Days / 5 Nights
                </h3>
