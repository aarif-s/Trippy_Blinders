...
const trips = [
    ...
    description: [
      {
        time: "",
        activities: [
          "Pick-up from Chandigarh/Kalka by private cab",
          "Scenic drive to Shimla (approx. 4–5 hours)",
          "Check-in at hotel",
          "Evening at leisure: explore Mall Road, Ridge, and Christ Church",
          "Dinner at hotel",
    ...
    description: [
      {
        ...
        activities: [
          "Breakfast at hotel",
          "Visit Kufri: horse riding, yak rides, Himalayan Nature Park",
          "Optional adventure at Kufri Fun World",
          "Visit Green Valley, Jakhoo Temple, and Sankat Mochan Temple",
          "Return to hotel, dinner, and overnight stay in Shimla"
        ]
      }
    ]
  },
  {
    id: 3,
    day: "Day 3",
    title: "Excursion to Naldehra & Tattapani",
    dayName: "Day 3",
    description: [
      {
        time: "",
        activities: [
          "Breakfast at hotel",
          "Full-day excursion to Naldehra (golf course and natural beauty)",
          "Visit Tattapani: optional river rafting and hot springs",
          "Return to hotel, dinner, and overnight stay in Shimla"
        ]
      }
    ]
    ...
    description: [
      {
        ...
        activities: [
          "Breakfast at hotel",
          "Check-out and drive back to Chandigarh/Kalka by private cab",
...
const inclusions = [
  {
    id: 1,
    category: "Stay",
    description: "Accommodation in well-rated hotel on double sharing basis"
  },
  {
    id: 2,
    category: "Meal",
  ...
  },
  {
    id: 3,
    category: "Transport",
    description: "Private cab for sightseeing and transfers (AC will not operate in hills)"
  },
  {
    id: 4,
    category: "Services",
    description: "All tolls, parking, fuel, driver allowances, pickup/drop from Chandigarh/Kalka, and hotel taxes"
  }
];

const exclusions = [
  { id: 1, description: "Any airfare/train fare" },
  { id: 2, description: "Lunch and personal expenses (laundry, tips, calls)" },
  { id: 3, description: "Entry tickets to monuments, parks, or activities" },
  { id: 4, description: "Extra charges during natural calamities or unrest" },
  { id: 5, description: "Travel insurance" },
  { id: 6, description: "Anything not mentioned in inclusions" }
];
  ...
  return (
    <div className="min-h-screen pt-16 bg-gray-50">
      ...
      <div
        ...
        style={{
          backgroundImage:
            'url("https://images.unsplash.com/photo-1636567652095-f59e54ed6d3a?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")',
        }}
      >
        <div className="w-full h-full bg-black bg-opacity-60 rounded-lg flex flex-col lg:flex-row items-center justify-between px-6 lg:px-20 py-12 lg:py-0 text-center lg:text-left pt-16">
          <div className="text-white max-w-lg mb-6 lg:mb-0">
            <h1 className="text-3xl lg:text-5xl font-bold mb-4 leading-tight">
              ...
              <span className="text-yellow-400">Spiti Trip</span>
            </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
        <section className="py-10 bg-gray-100">
          <h2 className="text-4xl font-bold text-center mb-12 text-gray-800">
            Explore <span className="text-blue-500">Upcoming Spiti Trip</span>
          </h2>
          ...
          <div className="flex flex-col space-y-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              Spiti Trip Itinerary : 8 Days / 7 Nights
              </h3>
