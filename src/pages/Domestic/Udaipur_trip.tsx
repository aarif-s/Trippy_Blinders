...
const trips = [
    {
      ...
      description: [
        {
          activities: [
            "Pick-up from Udaipur Airport/Railway Station by private AC cab",
            "Transfer and check-in at the hotel",
            "Leisure time to relax and freshen up",
            "Evening visit to Lake Pichola for a sunset boat ride",
            "Dinner at the hotel",
      ...
      description: [
        {
          activities: [
            ...
            "Walk around Saheliyon Ki Bari",
            "Visit Fateh Sagar Lake",
            "Tour the Vintage Car Museum",
    ...
    },
    {
      id: 3,
      day: "Day 3",
      title: "Excursion to Kumbhalgarh or Chittorgarh (Optional)",
      dayName: "Day 3",
      description: [
        {
          activities: [
            "Breakfast at the hotel",
            "Day excursion (choose one):",
            "- Kumbhalgarh Fort – Known for its massive walls and panoramic views",
            "- Chittorgarh Fort – UNESCO World Heritage Site symbolizing Rajput valor",
      ...
      description: [
        {
          activities: [
            "Breakfast at the hotel",
            "Check-out and drop to Udaipur Airport/Railway Station",
            "End of the tour with beautiful memories"
          ]
        }
      ]
    }
  ...
  const inclusions = [
    { id: 1, category: "Stay", description: "Accommodation in well-rated hotel on double sharing basis" },
    { id: 2, category: "Meals", description: "Daily breakfast and dinner at the hotel" },
    { id: 3, category: "Transport", description: "All transfers and sightseeing in private AC cab" },
    { id: 4, category: "Driver", description: "Experienced driver with local knowledge" },
    { id: 5, category: "Extras", description: "Toll, parking, fuel, and driver allowance" },
    { id: 6, category: "Activity", description: "Boat ride at Lake Pichola (shared basis)" },
    { id: 7, category: "Tax", description: "All applicable taxes" }
  ];
  
  const exclusions = [
    { id: 1, description: "Airfare or train fare to/from Udaipur" },
    { id: 2, description: "Entry tickets to monuments and attractions" },
    { id: 3, description: "Lunch, snacks, beverages not mentioned in inclusions" },
    { id: 4, description: "Personal expenses such as laundry, tips, telephone, etc." },
    { id: 5, description: "Travel insurance" },
    { id: 6, description: "Anything not mentioned in the ‘Inclusions’ section" }
  ];
  ...
  return (
    <div className="min-h-screen pt-16 bg-gray-50">
      ...
      <div
        ...
        style={{
          backgroundImage:
            'url("https://plus.unsplash.com/premium_photo-1697729789803-48b0c82365ff?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")',
        }}
      >
        <div className="w-full h-full bg-black bg-opacity-60 rounded-lg flex flex-col lg:flex-row items-center justify-between px-6 lg:px-20 py-12 lg:py-0 text-center lg:text-left pt-16">
          <div className="text-white max-w-lg mb-6 lg:mb-0">
            <h1 className="text-3xl lg:text-5xl font-bold mb-4 leading-tight">
              ...
              <span className="text-yellow-400">Udaipur Trip</span>
            </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
        <section className="py-10 bg-gray-100">
          <h2 className="text-4xl font-bold text-center mb-12 text-gray-800">
            Explore <span className="text-blue-500">Upcoming Udaipur Trip</span>
          </h2>
          ...
          <div className="flex flex-col space-y-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              Udaipur Itinerary – 4 Days / 3 Night
              </h3>
