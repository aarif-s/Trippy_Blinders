...
const trips = [
      ...
      description: [
        {
          time: "",
          activities: [
            "Pickup from Varanasi Airport / Railway Station by private AC cab",
            "Check-in at hotel and freshen up",
            "Evening visit to Dashashwamedh Ghat for the famous Ganga Aarti ceremony",
            "Stroll through local markets near the ghats",
            "Dinner at hotel",
      ...
      description: [
        {
          time: "",
          activities: [
            "Early morning boat ride on the Ganges to witness sunrise and rituals at the ghats",
            "Return to hotel for breakfast",
            "Visit Kashi Vishwanath Temple, Annapurna Temple, Kal Bhairav Temple",
            "Explore Banaras Hindu University (BHU), Bharat Kala Bhavan Museum",
            "Visit Sarnath (Dhamek Stupa, Sarnath Museum, Mulagandha Kuti Vihar)",
    ...
    },
    {
      id: 3,
      day: "Day 3",
      title: "Spiritual and Cultural Tour",
      dayName: "Day 3",
      description: [
        {
          time: "",
          activities: [
            "Breakfast at hotel",
            "Visit Tulsi Manas Mandir, Durga Temple, Sankat Mochan Hanuman Temple",
            "Explore Ramnagar Fort (museum and view of Ganges)",
            "Enjoy traditional Banarasi silk weaving demonstration",
            "Optional food walk or cultural show in the evening",
            "Dinner at hotel",
            "Overnight stay in Varanasi"
          ]
        }
      ...
      description: [
        {
          ...
          activities: [
            "Breakfast at hotel",
            "Free time for leisure/shopping at Godowlia or Thatheri Bazaar",
            "Check-out from hotel",
            "Transfer to airport/railway station by private cab for onward journey"
          ]
        }
      ]
    }
  ...
  const inclusions = [
    {
      id: 1,
      category: "Stay",
      description: "Accommodation in a 3-star hotel on twin sharing basis"
    },
    {
      id: 2,
      category: "Meal",
    ...
    },
    {
      id: 3,
      category: "Transport",
      description: "Private AC cab for all transfers and sightseeing as per itinerary"
    },
    {
      id: 4,
      category: "Experience",
    ...
    },
    {
      id: 5,
      category: "Services",
      description: "All applicable taxes, driver allowance, parking, and toll charges"
    },
    {
      id: 6,
      category: "Assistance",
      description: "Assistance on arrival and departure"
    }
  ];
  
  const exclusions = [
    { id: 1, description: "Lunch and beverages other than those mentioned" },
    { id: 2, description: "Entry fees at monuments and sightseeing places" },
    { id: 3, description: "Personal expenses like tips, laundry, and telephone bills" },
    { id: 4, description: "Airfare/train fare to and from Varanasi" },
    { id: 5, description: "Any additional sightseeing or usage of vehicle not mentioned in the itinerary" },
    { id: 6, description: "Travel insurance" },
    { id: 7, description: "Any costs arising due to natural calamities or unforeseen situations" }
  ];
  ...
  return (
    <div className="min-h-screen pt-16 bg-gray-50">
      ...
      <div
        ...
        style={{
          backgroundImage:
            'url("https://images.unsplash.com/photo-1719125733975-dcf234277a12?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")',
        }}
      >
        <div className="w-full h-full bg-black bg-opacity-60 rounded-lg flex flex-col lg:flex-row items-center justify-between px-6 lg:px-20 py-12 lg:py-0 text-center lg:text-left pt-16">
          <div className="text-white max-w-lg mb-6 lg:mb-0">
            <h1 className="text-3xl lg:text-5xl font-bold mb-4 leading-tight">
              ...
              <span className="text-yellow-400">Banaras Tour</span>
            </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
        <section className="py-10 bg-gray-100">
          <h2 className="text-4xl font-bold text-center mb-12 text-gray-800">
            Explore <span className="text-blue-500">Banaras Tour</span>
          </h2>
          ...
          <div className="flex flex-col space-y-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              Banaras (Varanasi) Tour Itinerary 4 Days / 3 Nights
              </h3>
