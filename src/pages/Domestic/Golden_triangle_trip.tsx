...
const trips = [
      ...
      description: [
        {
          time: "Morning",
          activities: [
            "Arrive in Delhi, the Capital City",
            "Transfer to hotel and check-in",
            "Relax and refresh before sightseeing",
          ],
        },
        {
          time: "Afternoon",
          activities: [
            "Visit India Gate, Parliament House, and Presidential Palace",
            "Explore Qutub Minar - UNESCO World Heritage Site",
            "Visit Lotus Temple for quiet introspection",
          ],
        },
        {
          time: "Evening",
    ...
    },
    {
      id: 2,
      day: "Day 2",
      title: "Delhi – Historical Monuments & Markets",
      dayName: "Tuesday",
      description: [
        {
          time: "Morning",
          activities: [
            "Visit Red Fort - UNESCO World Heritage Site",
            "Explore Jama Masjid",
            "Rickshaw ride through Chandni Chowk bazaar",
          ],
        },
        {
          time: "Afternoon",
          activities: [
            ...
            "Stroll through Dilli Haat for shopping and food",
          ],
        },
        {
          time: "Evening",
    ...
    },
    {
      id: 3,
      day: "Day 3",
      title: "Delhi to Agra – The City of Taj Mahal",
      dayName: "Wednesday",
      description: [
        {
          time: "Morning",
          activities: [
            "Depart from Delhi to Agra",
        ...
        },
        {
          time: "Afternoon",
          activities: [
            "Visit Taj Mahal – a symbol of love",
            "Explore Agra Fort – Mughal architecture",
    ...
    },
    {
      id: 4,
      day: "Day 4",
      title: "Agra to Jaipur – The Pink City",
      dayName: "Thursday",
      description: [
        {
          time: "Morning",
        ...
        },
        {
          time: "Afternoon",
          activities: [
            "Explore Amber Fort – ride an elephant or jeep",
        ...
        },
        {
          time: "Evening",
          activities: [
            "See Jal Mahal in Man Sagar Lake",
    ...
    },
    {
      id: 5,
      day: "Day 5",
      title: "Jaipur – Culture and Heritage",
      dayName: "Friday",
      description: [
        {
          time: "Morning",
          activities: [
            "Visit City Palace and its museums",
        ...
        },
        {
          time: "Evening",
          activities: [
            "Enjoy traditional Rajasthani dinner",
    ...
    },
    {
      id: 6,
      day: "Day 6",
      title: "Jaipur to Delhi – Shopping & Exploration",
      dayName: "Saturday",
      description: [
        {
          time: "Morning",
          activities: [
            "Drive back to Delhi from Jaipur",
            "Check-in at Delhi hotel and rest",
          ],
        },
        {
          time: "Afternoon",
          activities: [
            "Visit Akshardham Temple and enjoy boat ride",
          ],
        },
        {
          time: "Evening",
          activities: [
            "Shopping at Select Citywalk Mall or Dilli Haat",
            "Dinner and overnight stay in Delhi",
          ],
        },
      ],
      ...
      description: [
        {
          ...
          activities: [
            ...
            "Last-minute shopping or local sightseeing (optional)",
          ],
        },
        {
          time: "Afternoon",
          activities: [
            "Check-out and transfer to Delhi airport",
  ...
  return (
    <div className="min-h-screen pt-16 bg-gray-50">
      ...
      <div
        ...
        style={{
          backgroundImage:
            'url("https://images.pexels.com/photos/3881106/pexels-photo-3881106.jpeg")',
        ...
        <div className="w-full h-full bg-black bg-opacity-60 rounded-lg flex flex-col lg:flex-row items-center justify-between px-6 lg:px-20 py-12 lg:py-0 text-center lg:text-left pt-16">
          <div className="text-white max-w-lg mb-6 lg:mb-0">
            <h1 className="text-3xl lg:text-5xl font-bold mb-4 leading-tight">
              ...
              <span className="text-yellow-400">Golden Triangle Trip</span>
            </h1>
...
export default Golden_triangle_trip;
